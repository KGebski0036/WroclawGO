...
urlpatterns = [
    ...
    path('api/users/ranking/', UserRankingListView.as_view(), name='user-ranking-list'),
    path('api/users/<str:username>/', UserPublicProfileView.as_view(), name='user-public-profile'),
    path('api/users/<str:username>/favorite/', UserFavoriteToggleView.as_view(), name='user-favorite-toggle'),
]