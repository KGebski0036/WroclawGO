...
import { AvatarConstructorComponent } from './pages/avatar-constructor/avatar-constructor.component';
...
export const routes: Routes = [
  ...
  { path: 'register', component: RegisterComponent },
  {
    ...
    children: [
      ...
      { path: 'constructor', component: AvatarConstructorComponent },
      { path: 'wardrobe', redirectTo: 'constructor', pathMatch: 'full' },
      { path: 'customize', redirectTo: 'constructor', pathMatch: 'full' },
